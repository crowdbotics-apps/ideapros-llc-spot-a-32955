...
## Project Structure
    ...
    ├── ideapros_llc_spot_a_32955  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_spot_a_32955`
...
2. Clone this repo and `cd ideapros_llc_spot_a_32955`
